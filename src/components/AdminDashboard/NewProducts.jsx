...
export default function Layout() {
      ...
      <div className="main-content flex-1 bg-white h-[100vh] p-4">
        ...
        <div>
          <form className="border border-gray-300 p-4" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="title" className="fontBold">Product Title</label>
              <input
                type="text"
                id="title"
                name="title"
            ...
            <div>
              <label htmlFor="details" className="fontBold">Product Details</label>
              <textarea
                id="details"
                name="details"
                rows="4"
            ...
            <div>
              <label htmlFor="price" className="fontBold">Product Price ₦</label>
              <input
                type="text"
                id="price"
                name="price"
            ...
            <div>
              <label htmlFor="salePrice" className="fontBold">Sale Price ₦<span>(promo)</span></label>
              <input
                type="text"
                id="salePrice"
                name="salePrice"
  ...
  <div>
    ...
    />
            ...
            <div>
              <label htmlFor="schedule" className="fontBold block">Schedule</label>
              <button
                type="button"
      ...
      <div className="sidebar bg-gray-200 w-1/4 border border-gray-300 h-[100vh] overflow-scroll">
        <div>
          ...
          <button className="bg-black text-white  m-4 p-2 " onClick={handlePublish}>Submit</button>
        ...
        <h2 className="border-b border-gray-300 py-4 fontBold text-2xl">
            Product Image</h2>
          <div>
            <label htmlFor="frontImage" className="fontBold">Front Image</label>
            <input
              type="file"
              id="frontImage"
              accept="image/*"
          ...
          <div className="mt-4">
            <label htmlFor="alternateImage" className="fontBold">Alternate Image</label>
            <input
              type="file"
              id="alternateImage"
              accept="image/*"
          ...
          <div className="image-preview flex my-4">
            {frontImage && (
              <img src={frontImage} alt="Front Image" className="image h-14 mr-4 " />
            )}
            {alternateImage && (
              <img
                src={alternateImage}
        ...
        <div className="modal-overlay p-4">
          <div className="modal">
            ...
            <form onSubmit={handleNewCategorySubmit}>
              <div> 
                <label htmlFor="newCategory" className="fontBold">Category Name</label>
                <input
                  type="text"
                  id="newCategory"
                  name="newCategory"
              ...
              <div className="modal-buttons">
                <button type="submit" className="bg-black text-white mr-4 p-2">Add Category</button>
                <button className="bg-black text-white m-4 p-2" onClick={() => setShowModal(false)}>Cancel</button>
              </div>
            </form>
          </div>
        </div>
